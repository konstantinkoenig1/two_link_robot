...
model_dir = "./models_and_logs/A2C_default"
os.makedirs(model_dir, exist_ok=True)

# Create environment without rendering
env = FixedBaseRobotEnv(findings_log_path="models_and_logs/A2C_default/findings.txt") # not render_mode = "human" 



# Create the model
model = A2C('MlpPolicy', env, verbose=1, tensorboard_log=model_dir)
