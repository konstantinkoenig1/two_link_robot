...
# Training Algorithm
train_algorithm = "SAC"   ### change here

# Model Architecture
model_architecture = [64, 64]    ### change here
...
# Create the model
model = SAC('MlpPolicy', env, policy_kwargs=policy_kwargs, verbose=1, tensorboard_log=model_dir)  ### change here
