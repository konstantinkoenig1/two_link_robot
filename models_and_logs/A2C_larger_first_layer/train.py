...
model_dir = "./models_and_logs/A2C_larger_first_layer"
os.makedirs(model_dir, exist_ok=True)

# Create environment without rendering
env = FixedBaseRobotEnv(findings_log_path="models_and_logs/A2C_larger_first_layer/findings.txt") # not render_mode = "human" 
...
# Create the model
model = A2C('MlpPolicy', env, policy_kwargs=policy_kwargs, verbose=1, tensorboard_log=model_dir)
