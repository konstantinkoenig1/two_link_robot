...
# learning rate
learning_rate = 0.00003   ### change heres    <-------------
# Set the clip range
clip_range = 0.3     ### change heres   <-------------
# Set the discount factor
gamma = 0.999    ### change heres    <-------------
# Set weight decay for L2 regularization
weight_decay = 1e-4    ### change heres  <-------------
# Set entropy coefficient for entropy regularization
entropy_coefficient = 0.01  ### change heres  <-------------
