...
model_dir = "./models_and_logs/DDPG_extra_layer"
os.makedirs(model_dir, exist_ok=True)

# Create environment without rendering
env = FixedBaseRobotEnv(findings_log_path="models_and_logs/DDPG_extra_layer/findings.txt") # not render_mode = "human" 

# Configure custom network architecture
policy_kwargs = dict(activation_fn=th.nn.ReLU,
                     net_arch=dict(pi=[400, 350, 300], qf=[400, 350, 300]))
